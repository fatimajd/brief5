 			...
 			<div class="card">
 				...
 				<div class="card-body bg-light">
 					<a href="http://localhost/brief5/matiere/index" class='btn btn-sm btn-secondary mr-2 mb-2'>
						...
						<form action="http://localhost/brief5/matiere/update/<?php echo $matieres[0]['id']?>" method="POST">
							<div class="form-group">
 							<label for="libelle">Libelle Matiere*</label>
								<input type="text" name="libelle" class="form-control"  value="<?php echo $matieres[0]['libelle']?>">
