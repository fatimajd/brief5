 	...
 	<div class="row my-4">
 		<div class="col-md-10 mx-auto">
 			<div class="card">
 				...
 				<div class="card-body bg-light">
 					<a href="http://localhost/brief5/salle/create" class='btn btn-sm btn-primary mr-2 mb-2'>
					    ...
					    foreach ($salles as $salle):?>
					      ...
					      <td><?php echo $salle['capacite']; ?></td>
					       ...
					       <td class="d-flex flex-row">
					       	...
					       	<form action="http://localhost/brief5/salle/delete" method="post" class="mr-1" 
					       	onclick="deleteS()">
					       		
					       			<button  type="button" class="btn btn-sm btn-danger">
					       			<a href="http://localhost/brief5/salle/delete/<?=$salle['id']?>">
					       		<i class="fa fa-trash">
					       	...
					       	<form method="post" class="mr-1"  >
					       		...
					       		<button type="button" class="btn btn-sm btn-warning">
					       			<a href="http://localhost/brief5/salle/edit/<?=$salle['id']?>">
					       			<i class="fa fa-edit">
