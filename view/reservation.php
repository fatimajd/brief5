	...
	<div class="container">
 	<div class="row my-4">
 		<div class="col-md-8 mx-auto">
 			<div class="card">
 				<div class="card-header"> Ajouter Reservation</div>
 				
 				<div class="card-body bg-light">
 					<a href="http://localhost/brief5/reservation/index" class='btn btn-sm btn-secondary mr-2 mb-2'>
 						<i class="fas fa-home"></i>
 					</a>
						<form action="http://localhost/brief5/Reservation/save" method="post">
							...
							<?php }?>
			 						...
			 						<div class="form-group">
			 							<label for="nom">date de cours*</label>
						 					<input type="date" name="dateC" class="form-control" placeholder="Entrer la date">
			 						</div>
